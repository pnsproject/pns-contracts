...
| op_c_setPrice               | revert  |                                                       |
| op_p_mint                   | done    |                                                       |
| op_p_mintSubdomain          | done    |                                                       |
| op_p_burn                   | partial | tok是approved的情况未覆盖                             |
| op_p_bound                  | partial | tok是approved的情况未覆盖                             |
...
| op_p_setName                | partial | tok是approved的情况未覆盖                             |
| op_p_setNftName             | partial | tok是approved的情况未覆盖、合约是approved的情况未覆盖 |
| op_p_addKeys                | done    |                                                       |
| op_p_setByHash              | done    |                                                       |
| op_p_setManyByHash          | done    |                                                       |
| op_p_setlink                | done    |                                                       |
| op_p_setlinks               | done    |                                                       |
| chk_p_register              | revert  |                                                       |
| chk_p_renew                 | done    |                                                       |
| aop_pns_safeTransferFrom    | done    |                                                       |
| aop_pns_approved            | partial |                                                       |
| aop_nft_set_owner           | done    |                                                       |
| aop_nft_transfer            | partial |                                                       |
| aop_set_price               | partial |                                                       |
| st_p_getName                | done    |                                                       |
| st_p_bounded                | done    |                                                       |
| st_p_nameExpired            | done    |                                                       |
| st_p_available              | done    |                                                       |
| st_c_totalRegisterPrice     | partial | name长度小于数组长度未覆盖、溢出情况未覆盖            |
| st_c_renewPrice             | partial | name长度小于数组长度未覆盖、溢出情况未覆盖            |
#+caption: 覆盖情况统计
